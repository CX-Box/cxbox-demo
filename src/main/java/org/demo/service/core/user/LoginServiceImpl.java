...
package org.demo.service.core.user;
...
public class LoginServiceImpl implements LoginService {
	...
	public LoggedUser getLoggedUser(String role) {
		...
		LoggedUser build = LoggedUser.builder()
				...
				.build();
		FieldUtils.writeField(build, "lastName", userEntity.getLastName(), true);
		FieldUtils.writeField(build, "firstName", userEntity.getFirstName(), true);
		FieldUtils.writeField(build, "patronymic", userEntity.getPatronymic(), true);
		FieldUtils.writeField(build, "fullName", userEntity.getFullName(), true);
		FieldUtils.writeField(build, "principalName", userEntity.getUserPrincipalName(), true);
		FieldUtils.writeField(build, "phone", userEntity.getPhone(), true);
		return build;
