...
public class ResponsibilitesMeta extends FieldMetaBuilder<ResponsibilitesCrudDTO> {
	...
	public void buildRowDependentMeta(RowDependentFieldsMeta<ResponsibilitesCrudDTO> fields,
		...
		List<SimpleDictionary> viewNameSimple = new ArrayList<>();

		diffViewDBMeta()
				.forEach(resp -> viewNameSimple.add(new SimpleDictionary(resp.getView(), resp.getView(), true)));
		fields.setConcreteValues(ResponsibilitesCrudDTO_.view, viewNameSimple);
