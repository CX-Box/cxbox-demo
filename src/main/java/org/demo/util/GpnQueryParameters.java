...
public final class GpnQueryParameters {
	...
	public GpnQueryParameters(Map<String, String> parameters) {
		this.parameters = parameters;
	}

	public static GpnQueryParameters of(final Map<String, String[]> parameters) {
		...
		return new GpnQueryParameters(singleValueMap);
	}
	...
	public boolean equals(Object obj) {
		...
		var that = (GpnQueryParameters) obj;
