...
function BaseTable<T extends { id: unknown }>({
    columns,
    widgetName,
    wrapperRef,
    ...
    const mergedWrapperRef = useMergeRefs([tableContainerRef, wrapperRef])
    ...
    const tableElement = (
        <div
            className={cn(styles.tableContainer, { [styles.stickyWithHorizontalScroll]: stickyWithHorizontalScroll })}
        ...
        >
            ...
            <div className={styles.tableWrapper}>
                ...
                <AntdTable
                    ...
                    onExpand={onExpand}
                    indentSize={0}
                    scroll={stickyWithHorizontalScroll ? { y: true, x: '100%' } : undefined}
                    {...rest}
                />
            </div>
