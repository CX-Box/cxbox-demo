import { CounterType, GroupingHierarchyEmptyGroupNode, GroupingHierarchyGroupNode } from '@components/Table/groupingHierarchy'
import { countersTypeToParamKey } from '@components/Table/groupingHierarchy/constants'
