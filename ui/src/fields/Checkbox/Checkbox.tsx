...
import { ChangeDataItemPayload } from '@features/Field/Field'
 ...
 * @category Components
 */
const Checkbox: React.FC<CheckboxPickerProps> = ({ metaField, bcName, cursor, fieldName, value, readonly, placeholder, onChange }) => {
