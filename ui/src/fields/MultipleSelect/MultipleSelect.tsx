...
import styles from './MultipleSelect.less'
import Checkbox from '@fields/MultipleSelect/Checkbox'
...
const MultipleSelect: React.FunctionComponent<MultipleSelectFieldProps> = props => {
