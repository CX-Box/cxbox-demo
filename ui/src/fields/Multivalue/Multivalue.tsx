...
import styles from './Multivalue.less'
 ...
 * @category Components
 */
const Multivalue: FunctionComponent<MultivalueFieldProps> = props => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Multivalue)
