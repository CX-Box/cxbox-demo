...
import { AdditionalInfoHeader } from './AdditionalInfoHeader'
import styles from './AdditionalInfoItem.module.less'
...
export const AdditionalInfoItem: React.FC<Props> = ({ meta, cursor, rowMeta }) => {
