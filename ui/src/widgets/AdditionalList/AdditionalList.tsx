...
import { StandardWrapper } from '../AdditionalInfo/StandardWrapper'
import { DataItem } from '@cxbox-ui/core'
import { AdditionalInfoHeader } from '../AdditionalInfo/AdditionalInfoHeader'
...
import styles from './AdditionalList.module.less'
...
export const AdditionalList: React.FC<Props> = ({ meta }) => {
