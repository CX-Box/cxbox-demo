...
const FormPopup: WidgetComponentType = ({ widgetMeta }) => {
    ...
    const popupTitle = (
        <WidgetTitle className={styles.title} level={1} widgetName={widgetMeta.name} text={preInvoke?.message ?? widgetMeta.title} />
    )
